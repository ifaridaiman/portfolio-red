...
Technical implementation guide for **Admin Dashboard** in the monorepo.
...
|-------|----------------|
| Routes | `apps/web/app/...` |
| Feature code | `apps/web/features/admin/` |
| Shared UI | `@repo/ui` |
...
- Session-based or OAuth (provider TBD in ADR)
- Middleware protection on `/admin` routes
- RBAC: single owner role in v1
...
- Export public API from `features/admin/index.ts`
