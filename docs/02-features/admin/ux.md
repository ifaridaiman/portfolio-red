...
Define user experience, flows, and interaction design for **Admin Dashboard**.
...
1. User navigates to the admin dashboard entry point (see [technical.md](./technical.md) for routes).
