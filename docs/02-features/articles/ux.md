# Articles — UX Specification

## Purpose

Define user experience, flows, and interaction design for **Articles**.
...
1. User navigates to the articles entry point (see [technical.md](./technical.md) for routes).
