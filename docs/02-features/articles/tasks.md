...
Actionable work breakdown for implementing **Articles**.

## Scope

Engineering tasks for this feature. Milestone: **M2** per [roadmap](../../00-product/roadmap.md).
...
- [ ] Dependent platform work for milestone M2 is complete

## Implementation Tasks

### Setup

- [ ] Create `apps/web/features/articles/` module structure
...
Database, MDX pipeline, RAG ingestion
