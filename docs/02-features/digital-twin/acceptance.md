...
Testable definition of done for **Digital Twin** releases.
...
- [ ] Feature routes for Digital Twin are reachable and return HTTP 200
...
- [ ] Chat streams assistant responses incrementally
- [ ] Factual responses include source citations with working links
- [ ] AI unavailable state shows graceful fallback message
- [ ] Token usage is logged server-side per message
