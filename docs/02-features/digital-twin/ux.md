# Digital Twin — UX Specification

## Purpose

Define user experience, flows, and interaction design for **Digital Twin**.
...
1. User navigates to the digital twin entry point (see [technical.md](./technical.md) for routes).
