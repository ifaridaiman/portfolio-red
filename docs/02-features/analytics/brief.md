...
Privacy-conscious traffic and engagement metrics for the portfolio owner.

## Scope

This feature covers user-facing and admin-facing capabilities for **analytics** within `apps/web`. Out-of-scope items are listed in each sibling document.
...
| Implementation | `apps/web/features/analytics/` |
| Data model | See [database.md](../../01-architecture/database.md) |
| AI (if applicable) | See [ai.md](../../01-architecture/ai.md) |

## Problem Statement

Visitors need a clear, credible way to engage with **analytics** as part of the AI Engineering Portfolio Platform. This feature must align with [engineering principles](../../00-product/engineering-principles.md): accessible, performant, and observable.
...
Database, admin auth, observability
...
- Keep routes thin; colocate logic under `features/analytics/`.
- Reference [roadmap](../../00-product/roadmap.md) milestone for delivery timing.

## Examples

Primary user journey for **Analytics** is documented in [ux.md](./ux.md).
