# Contact — UX Specification

## Purpose

Define user experience, flows, and interaction design for **Contact**.
...
1. User navigates to the contact entry point (see [technical.md](./technical.md) for routes).
