# Projects — UX Specification

## Purpose

Define user experience, flows, and interaction design for **Projects**.
...
1. User navigates to the projects entry point (see [technical.md](./technical.md) for routes).
