...
Public marketing entry point introducing the portfolio owner, value proposition, and primary CTAs.

## Scope

This feature covers user-facing and admin-facing capabilities for **landing page** within `apps/web`. Out-of-scope items are listed in each sibling document.
...
| Implementation | `apps/web/features/landing/` |
| Data model | See [database.md](../../01-architecture/database.md) |
| AI (if applicable) | See [ai.md](../../01-architecture/ai.md) |

## Problem Statement

Visitors need a clear, credible way to engage with **landing page** as part of the AI Engineering Portfolio Platform. This feature must align with [engineering principles](../../00-product/engineering-principles.md): accessible, performant, and observable.

## Target Users

First-time visitors, recruiters, peers
...
- Keep routes thin; colocate logic under `features/landing/`.
- Reference [roadmap](../../00-product/roadmap.md) milestone for delivery timing.

## Examples

Primary user journey for **Landing Page** is documented in [ux.md](./ux.md).
