# Portfolio Overview — Technical Specification

## Purpose

Technical implementation guide for **Portfolio Overview** in the monorepo.
...
|-------|----------------|
| Routes | `apps/web/app/...` |
| Feature code | `apps/web/features/portfolio/` |
| Shared UI | `@repo/ui` |
...
- Export public API from `features/portfolio/index.ts`
