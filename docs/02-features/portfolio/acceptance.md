# Portfolio Overview — Acceptance Criteria

## Purpose

Testable definition of done for **Portfolio Overview** releases.
...
- [ ] Feature routes for Portfolio Overview are reachable and return HTTP 200
