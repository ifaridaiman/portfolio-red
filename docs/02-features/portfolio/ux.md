# Portfolio Overview — UX Specification

## Purpose

Define user experience, flows, and interaction design for **Portfolio Overview**.
...
1. User navigates to the portfolio overview entry point (see [technical.md](./technical.md) for routes).
