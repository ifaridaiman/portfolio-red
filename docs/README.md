...
Entry point for the AI Engineering Portfolio Platform documentation system.
...
| [05-standards](./05-standards/) | Code, frontend, AI, design, testing standards |
| [06-development](./06-development/) | Workflow, branching, checklists |
| [07-deployment](./07-deployment/) | Local dev, Docker, CI/CD, rollback |
| [08-observability](./08-observability/) | Logging, metrics, tracing, alerts |
